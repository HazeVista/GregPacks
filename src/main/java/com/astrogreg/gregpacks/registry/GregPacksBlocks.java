...
public class GregPacksBlocks {
    ...
    public static final BlockEntry<OmniPackBlock> BASIC_OMNIPACK_BLOCK = GregPacks.REGISTRATE.block("basic_omnipack",
    ...
    public static final BlockEntry<OmniPackBlock> ADVANCED_OMNIPACK_BLOCK = GregPacks.REGISTRATE
    ...
    public static final BlockEntry<OmniPackBlock> ELITE_OMNIPACK_BLOCK = GregPacks.REGISTRATE.block("elite_omnipack",
